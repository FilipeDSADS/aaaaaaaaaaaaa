...
import useWebSocket from './useWebSocket'; // Certifique-se de que o hook useWebSocket está implementado
import Kanban from './Kanban'; // Importando o Kanban
...
const Cartoes = () => {
    ...
    useWebSocket(handleNewCartao); // Usar o hook para escutar novos cartões
